    ...
    <div className={classes.box} id='interest'>
      ...
      <div className={classes.Interest}>
        ...
        <div className={classes.web}>
          ...
          <p>
            I have knowledge of flutter development and have experience in building android . I also have live projects published on Google Play Store.
          </p>
        </div>
        {/* </ScrollAnimation>
          <ScrollAnimation
        ...
        <div className={classes.app}>
          ...
          <p>
            Javascript/ Typescript, HTML/ CSS, ReactJs, Next.js, Redux, Tailwind
